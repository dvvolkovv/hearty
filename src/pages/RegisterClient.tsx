...
import { Eye, EyeOff, UserPlus, Heart, CheckCircle2, Mail } from 'lucide-react'
      ...
      <div className="w-full max-w-md">
        <div className="bg-white border-2 border-border rounded-[3rem] p-12 shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground mb-2">Регистрация клиента</h1>
            <p className="text-sm text-muted-foreground">Создайте аккаунт для поиска специалиста</p>
          </div>
