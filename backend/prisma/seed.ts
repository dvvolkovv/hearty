  ...
  const specialistsData = [
    {
      ...
      location: 'Москва',
      format: ['Онлайн', 'Лично'],
      tags: ['Отношения', 'Самооценка', 'Тревога', 'Гештальт'],
    ...
    },
    {
      ...
      format: ['Онлайн'],
      tags: ['Бизнес', 'Эффективность', 'Личность'],
    ...
    },
    {
      ...
      location: 'Москва',
      format: ['Онлайн', 'Лично'],
      tags: ['Отношения', 'События', 'Самооценка'],
    ...
    },
    {
      ...
      location: 'Москва',
      format: ['Онлайн', 'Лично'],
      tags: ['Бизнес', 'Эффективность', 'Выгорание', 'Лидерство'],
    ...
    },
    {
      ...
      location: 'Казань',
      format: ['Онлайн'],
      tags: ['Личность', 'События', 'Самооценка', 'Арт-терапия'],
